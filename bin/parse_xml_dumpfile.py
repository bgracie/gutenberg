...
this was taken from: https://gist.github.com/wwymak/6e4fd6ca13928e63aa8c
"""
...
def parsemetadata(ebook):
  ...
  # subject lists
    #rather than using sets for subjects and LCC, use lists instead
    #as they are json serialisable
...
def saveToJson(filename):
    """
    This is to save the file to json
    """
    md = readmetadata()
    with open(filename, 'w') as f:
        json.dump(md, f)

__all__ = ['readmetadata', 'saveToJson']
